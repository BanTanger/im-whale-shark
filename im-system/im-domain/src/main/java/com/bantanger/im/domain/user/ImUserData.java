...
import com.bantanger.im.infrastructure.converter.FriendAllowTypeConverter;
import com.bantanger.im.infrastructure.converter.UserTypeConverter;
...
@GenVo(pkgName = "com.bantanger.im.domain.user.vo")
@GenCreator(pkgName = "com.bantanger.im.domain.user.creator")
@GenUpdater(pkgName = "com.bantanger.im.domain.user.updater")
@GenRepository(pkgName = "com.bantanger.im.domain.user.repository")
@GenService(pkgName = "com.bantanger.im.domain.user.service")
@GenServiceImpl(pkgName = "com.bantanger.im.domain.user.service")
@GenQuery(pkgName = "com.bantanger.im.domain.user.query")
@GenMapper(pkgName = "com.bantanger.im.domain.user.mapper")
@GenController(pkgName = "com.bantanger.im.domain.controller")
@GenCreateRequest(pkgName = "com.bantanger.im.domain.user.request")
@GenUpdateRequest(pkgName = "com.bantanger.im.domain.user.request")
@GenQueryRequest(pkgName = "com.bantanger.im.domain.user.request")
@GenResponse(pkgName = "com.bantanger.im.domain.user.response")
@Entity

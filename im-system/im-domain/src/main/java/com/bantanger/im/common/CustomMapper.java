...
public class CustomMapper {
    ...
    public Integer GroupMemberRoleType2Int(GroupMemberRoleType groupMemberRoleType) {
        return groupMemberRoleType.getCode();
    }

    public GroupMemberRoleType int2GroupMemberRoleType(Integer code) {
        return GroupMemberRoleType.of(code).orElse(null);
    }

    public Integer GroupMuteType2Int(GroupMuteType groupMuteType) {
        return groupMuteType.getCode();
    }

    public GroupMuteType int2GroupMuteType(Integer code) {
        return GroupMuteType.of(code).orElse(null);
    }

    public Integer GroupStatusType2Int(GroupStatusType groupStatusType) {
        return groupStatusType.getCode();
    }

    public GroupStatusType int2GroupStatusType(Integer code) {
        return GroupStatusType.of(code).orElse(null);
    }

    public Integer GroupType2Int(GroupType groupType) {
        return groupType.getCode();
    }

    public GroupType int2GroupType(Integer code) {
